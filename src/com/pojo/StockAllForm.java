...
public class StockAllForm {
        private int mId;//药品id
        ...
        private String profits;//利润金额
        private String code;//自编码
        private String goodsType;//商品分类
        private String mType;//药品分类
        private String defined;//自定义类
        private String supplier;//供货商
        private String warehousingDate;//入库日期
        private String locationDescription;//货位说明
    ...
    public int getmId() {
        ...
        public void setTimesStorage(int timesStorage) {
            this.timesStorage = timesStorage;
        }
        ...
        public String getBatchsNumber() {
            return batchsNumber;
        }

        public void setBatchsNumber(String batchsNumber) {
            this.batchsNumber = batchsNumber;
        }
