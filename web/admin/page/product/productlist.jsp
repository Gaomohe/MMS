...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <c:forEach var="i" items="${requestScope.proBtn}">
                ${i.mbtn}
            </c:forEach>
        </script>
...
<script type="text/html" id="Img">
    <img src="http://localhost:8090/files/{{d.fileName}}"/>
</script>
...
<script type="text/javascript" language="JavaScript" src="<%=basePath %>admin/pagejs/product/productlist.js" charset="UTF-8"></script>
