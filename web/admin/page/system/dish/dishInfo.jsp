...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="id" id="id" value="${dish.id}" lay-verify="required" readonly disabled="" placeholder="用户编号" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <br/><br/>
    <div class="layui-form-item">
        <button class="layui-btn layui-btn-fluid" id="submit" lay-submit lay-filter="required">修改</button>
    </div>
</form>
...
<script type="text/javascript" src="<%=basePath %>admin/pagejs/system/dish/dishInfo.js"></script>
</body>
</html>