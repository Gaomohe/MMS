...
<script src="<%=basePath %>admin/lib/layui-v2.5.5/layui.js" charset="utf-8" charset="utf-8"></script>
<script src="<%=basePath %>admin/js/lay-config.js?v=1.0.4" charset="utf-8" charset="utf-8"></script>
<script>
