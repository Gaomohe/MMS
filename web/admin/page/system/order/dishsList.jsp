...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="dishDemo">
...
<script type="text/javascript" language="JavaScript" src="<%=basePath %>admin/pagejs/system/order/dishsList.js" charset="UTF-8"></script>
