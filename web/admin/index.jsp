...
<body class="layui-layout-body layuimini-all">
	<%--<%
		User list = (User) request.getSession().getAttribute("user");
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="http://localhost:8080/EasyBuys/IndexServlet?action=index">退回到商品首页</a>
                        </dd>
                        <dd>
                            <a href="http://localhost:8090/" class="login-out">退出登录</a>
                        </dd>
                    </dl>
                </li>
