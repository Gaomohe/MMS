layui.extend({
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'manufactor', title:'生产企业' , width:150, align:"center"},
            {field: 'unit', title:'单位' , width:150, align:"center"},
            {field: 'oNum', title:'订单数量' , width:150, align:"center"},
            {field: 'salePrice', title:'采购单价' , width:150, align:"center"},
            {field: 'shippingAddress', title:'发货地址' , width:150, align:"center"},
            {field: 'deliveryAddress', title:'收货地址' , width:150, align:"center"},
            {field: 'shippingTime', title:'发货时间' , width:150, align:"center"},
            {field: 'shippingWay', title:'发货方式' , width:150, align:"center"},
            {field: 'tempControlWay', title:'温控方式' , width:150, align:"center"},
            {field: 'deliveryTime', title:'到货时间' , width:150, align:"center"},
            {field: 'deliveryTemp', title:'到货温度' , width:150, align:"center"},
            {field: 'attachment', title:'关联附件' , width:150, align:"center"},
            {field: 'salesman', title:'供货单位业务员' , width:150, align:"center"},
            {field: 'buyer', title:'采购人' , width:150, align:"center"},
            {field: 'recipient', title:'收货人' , width:150, align:"center"},
            {field: 'condition', title:'收货状态' , width:150, align:"center"},
            {field: 'statement', title:'收货说明' , width:150, align:"center"}
        ]],
    });
