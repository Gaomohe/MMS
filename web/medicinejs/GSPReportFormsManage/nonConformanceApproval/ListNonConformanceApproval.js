layui.extend({
    ...
    function getChoise02(){
        ...
        var series=[];
        $.ajax({
            url:"/nonConformanceApproval?action=getChoise02",//根据id查询的方法
            type:"post",
            data:{},
            success:function (data){
                var parse = JSON.parse(data).data;
    ...
    function getChoise01(){
        ...
        var series=[];
        $.ajax({
            url:"/nonConformanceApproval?action=getChoise01",//根据id查询的方法
            type:"post",
            data:{},
            success:function (data){
                var parse = JSON.parse(data).data;
    ...
    function getAjax(day){
        ...
        var series=[];
        $.ajax({
            url:"/nonConformanceApproval?action=getAllDay",//根据id查询的方法
            type:"post",
            data:{day},
            success:function (data){
                var parse = JSON.parse(data).data;
    ...
    var tableIns = table.render({
        elem: '#purchaseList',
        url : '/nonConformanceApproval?action=getAll',
        cellMinWidth : 95,
        page : true,
        ...
        cols : [[
            ...
            {field: 'pharmacist', title: '审批人', minWidth:100, align:"center"},
            {field: 'pharmacistApprove', title: '状态', minWidth:100, align:"center"},
            {field: 'pharmacistTime', title: '时间', minWidth:100, align:"center"},
