layui.extend({
    ...
    function getChoise02(){
        ...
        var series=[];
        $.ajax({
            url:"/pharmaceuticalSales?action=getChoise02",//根据id查询的方法
            type:"post",
            data:{},
            success:function (data){
                var parse = JSON.parse(data).data;
    ...
    function getChoise01(){
        ...
        var series=[];
        $.ajax({
            url:"/pharmaceuticalSales?action=getChoise01",//根据id查询的方法
            type:"post",
            data:{},
            success:function (data){
                var parse = JSON.parse(data).data;
    ...
    function getAjax(day){
        ...
        var series=[];
        $.ajax({
            url:"/pharmaceuticalSales?action=getAllDay",//根据id查询的方法
            type:"post",
            data:{day},
            success:function (data){
                var parse = JSON.parse(data).data;
