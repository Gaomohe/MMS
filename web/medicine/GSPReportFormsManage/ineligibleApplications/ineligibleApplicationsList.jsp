                    ...
                    <div class="container">
                        <div class="left-div">
                            ...
                            <ul id="nav" class="layui-nav layui-nav-tree" style="background-color: #000000;color: black">
                                ...
                                <li class="layui-nav-item"><a href="javascript:;">不合格申请类型</a></li>
                                <li class="layui-nav-item"><a href="javascript:;">不合格申请商品</a></li>
...
<script type="text/javascript" src="<%=basePath %>medicinejs/GSPReportFormsManage/ineligibleApplications/ListineligibleApplications.js" charset="utf-8"></script>
</body>
