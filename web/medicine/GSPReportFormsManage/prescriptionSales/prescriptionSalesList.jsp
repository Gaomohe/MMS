                    ...
                    <div class="container">
                        <div class="left-div">
                            ...
                            <ul id="nav" class="layui-nav layui-nav-tree" style="background-color: #000000;color: black">
                                ...
                                <li class="layui-nav-item"><a href="javascript:;">销售处方类型</a></li>
                                <li class="layui-nav-item"><a href="javascript:;">销售处方商品</a></li>
...
<script type="text/javascript" src="<%=basePath %>medicinejs/GSPReportFormsManage/prescriptionSales/ListprescriptionSales.js" charset="utf-8"></script>
</body>
