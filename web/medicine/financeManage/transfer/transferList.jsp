        ...
        <div class="layui-row">
            <div class="layui-col-xs6">
                <div class="layui-inline">
                    <label style="width: auto;" class="layui-form-label">日期选择:</label>
            ...
            <div class="layui-col-xs2">
                <input id="name" type="text" name="" placeholder="请输入" class="layui-input">
            </div>
        ...
        <div class="layui-row">
            ...
            <div class="layui-col-xs2">
                <select>
                    ...
                    <c:forEach var="finance2" items="${finance2}" varStatus="s">
                        <option value="${finance2.cName}">${finance2.cName}</option>
                    </c:forEach>
                </select>
            </div>
            <div class="layui-col-xs2">
                <select>
                    ...
                    <c:forEach var="account2" items="${account2}" varStatus="s">
                        <option value="${account2.supName}">${account2.supName}</option>
                    </c:forEach>
...
<script type="text/javascript" src="<%=basePath %>medicinejs/financeManage/transferjs/listTransf.js" charset="utf-8"></script>
