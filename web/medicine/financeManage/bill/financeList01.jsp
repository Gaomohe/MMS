                ...
                <form class="layui-form" action="">
                    ...
                    <div class="layui-col-xs2">
                        <select id="show1-kind">
                            ...
                            <option value="北京">收入单</option>
                            <option value="上海">支出单</option>
                            <option value="广州">预付款单</option>
                        </select>
                    </div>
                    </div>
<%--                    <hr>--%>
                    <div class="layui-row">
                        <div class="layui-col-xs8">
                            ...
                            <button lay-event="del" class="layui-btn layui-btn-primary layui-border"><i class="bi bi-trash"></i> 删除</button>
                        ...
                        <div class="layui-col-xs4">
                            <button lay-event="add" type="button" class="layui-btn"><i class="bi bi-plus"></i> 新增单据</button>
            ...
            <script type="text/html" id="incomeDemo">
                <form class="layui-form" action="">
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs3">
                            <input id="show2-id" type="text" name="" placeholder="请输入单据编号" class="layui-input">
                        </div>
                        <div class="layui-col-xs2">
...
<%--            内容-3-支出--%>
    <script type="text/html" id="spendDemo">
        <form class="layui-form" action="">
            <div class="layui-row">
                <div class="layui-col-xs3">
                    <input type="text" name="" placeholder="请输入商品名称" class="layui-input">
                </div>
                <div class="layui-col-xs3">
                    <input type="text" name="" placeholder="请输入单据编号" class="layui-input">
                </div>
                <div class="layui-col-xs2">
                    <select>
                        <option value="">选择供应商</option>
