...
<form class="layui-form layui-form-pane" action="Javascript:void(0)">
    <div class="layui-form-item" style="display: none">
        <label class="layui-form-label">坏品单号</label>
        <div class="layui-input-inline">
            <input readonly type="text" name="id" id="id" value="<%=applyId%>" class="layui-input">
        </div>
    </div>
...
<script type="text/javascript" src="<%=basePath%>medicinejs/qualityManage/defectiveDisposal/updateFailed.js"></script>
</body>
</html>