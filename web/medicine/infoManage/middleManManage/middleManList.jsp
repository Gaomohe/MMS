...
<div class="layuimini-container">
  <div class="layuimini-main">
    ...
    <script type="text/html" id="middleManDemo">
      <c:forEach var="menu" items="${menuList}" varStatus="s">
        ${menu.resUrl}
      </c:forEach>
    </script>

    <table id="middleManList" lay-filter="middleManList"></table>
  </div>
</div>
...
<script type="text/javascript" src="<%=basePath %>medicinejs/infoManage/middleManManage/middleManList.js" charset="utf-8"></script>
</body>
</html>