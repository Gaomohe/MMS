...
<div id="container">
    ...
    <div class="row" style="margin-bottom: 50px">
        ...
        <script id="tableOneDemo"></script>
    </div>
    <!-- signature -->
    <div class="row">
        <p style="color: black">
            请仔细查看上述开出药品，完成后请在下面签名。
        </p>
...
<script type="text/javascript" language="JavaScript" src="<%=basePath %>medicinejs/outpatientManager/outpatient/signature.js" charset="UTF-8"></script>
</html>
